...
面向国内开发者的本地 Coding Agent：中文优先、记忆可验证、会复盘、兼容国内模型，并认真对待 Windows 体验。
...
- 国内模型、网络环境与 Windows 用户经常不是现有工具的首要考虑对象。
...
- [ ] M1：可完成真实任务的最小 Agent Runtime
- [ ] M2：事件持久化、恢复、上下文压缩与 Patch Journal
- [ ] M3：可审计的可信记忆
- [ ] M4：默认只生成提案的复盘机制

完整决策、接口草案和里程碑见 [ARCHITECTURE.md](./ARCHITECTURE.md)。
...
- 帮助建立可重复的真实任务与记忆评测；
- 讨论国内 Provider、Windows 执行隔离与终端体验；
