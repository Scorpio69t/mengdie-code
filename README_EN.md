...
- [x] Phase 2 Slice 06A: Patch Journal write facts and crash classification ([implementation report, Chinese](./docs/development/phase-2-slice-06a/IMPLEMENTATION_REPORT.md))
- [x] Phase 2 Slice 06B: rollback material, explicit approval, and safe rewind ([implementation report, Chinese](./docs/development/phase-2-slice-06b/IMPLEMENTATION_REPORT.md))
- [x] Phase 2 Slice 07: project instructions and minimal on-demand Skills ([implementation report, Chinese](./docs/development/phase-2-slice-07/IMPLEMENTATION_REPORT.md))
